...
import 'package:museo_zuccante/core/presentation/customization/custom_shimmer.dart';
...
class ItemsLoadingState extends StatelessWidget {
    ...
    return RefreshIndicator(
      ...
      child: Scrollbar(
        child: ListView(
          ...
          children: [
            buildLoadingSearchBar(context),
            buildTopVisitedSection(context),
            buildLoadingNewsAndExibitions(context)
          ],
        ),
      ),
    );
  ...
  Widget buildLoadingNewsAndExibitions(BuildContext context) {
    return Column(
  ...
  Widget buildTopVisitedSection(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
  ...
  Widget buildLoadingSearchBar(BuildContext context) {
    return Container(
